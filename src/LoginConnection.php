...
class LoginConnection{
    ...
    public function init($url) {
        $this->url = $url;
        $this->headers = array('UUID: '.config('BaiduStat.UUID'), 'account_type: '.config('BaiduStat.ACCOUNT_TYPE'), 'Content-Type:  data/gzencode and rsa public encrypt;charset=UTF-8');
    }
